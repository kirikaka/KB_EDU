...
public class FileBasic {
    ...
    // C:\dev_source\work_space_java\kb6_lecture\05_IO\covid.txt
    // c:\test\data.txt
    ...
    // - ex) './covid.txt', 'covid.txt', './../05_IO/covid.txt'

    public static void main(String[] args) {
        // 상대 경로로 열기
        File file = new File("./");
        System.out.println(file.getAbsolutePath()); // 절대경로 위치 확인
//		File file1 = new File("./05_IO/covid.txt"); // 상대 경로로 열림(open)
        File file1 = new File("05_IO/covid.txt"); // 파일/폴더의 경로명

        // 절대 경로로 열기
//		File file2 = new File("C:\\dev_source\\work_space_java_multi1030\\05_IO\\covid.txt");
...
//		file1.delete();
        ...
        // 디렉토리 생성 ★
//		folder.mkdirs() : 입력된 경로에 폴더가 없으면 모두 생성
//		folder.mkdir() : 입력된 경로에 폴더만 생성
