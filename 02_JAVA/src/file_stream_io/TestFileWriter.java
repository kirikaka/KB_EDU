...
public class TestFileWriter {
	...
	public static void main(String[] args) {
		...
		try {
			// 오픈부
//			fw = new FileWriter("05_IO/test2.txt"); // 기본형
//			fw = new FileWriter("05_IO/test2.txt", Charset.forName("utf-8")); // 인코딩 강제화
//			fw = new FileWriter("05_IO/test2.txt", true); // append 옵션 -> 이어쓰기
			fw = new FileWriter("05_IO/test2.txt", StandardCharsets.UTF_8, true); // 인코딩 + append 같이 쓸 때
