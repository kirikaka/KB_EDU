...
public class FileCopy {
	...
	public static void main(String[] args) {
		File source1 = new File("../05_IO/covid.txt");
		File dest1 = new File("../05_IO/copy1_covid.txt");
		File dest2 = new File("../05_IO/copy2_covid.txt");
		...
		// UTF-16 복사
		File source2 = new File("../05_IO/covid_UTF16.txt");
		File dest3 = new File("../05_IO/copy3_covid_UTF16.txt");
		File dest4 = new File("../05_IO/copy4_covid_UTF16.txt");
		...
		File source3 = new File("../05_IO/image.jpg");
		File dest5 = new File("../05_IO/copy5_image.jpg");
		File dest6 = new File("../05_IO/copy6_image.jpg");
